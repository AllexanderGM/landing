...
!(function (a) {
  ...
  (b.prototype = {
      ...
      if (!g) {
        ...
        if (
          ...
          a.each(b.contentFilters, function () {
            return (
              (g = c[this]), g.test && (f = g.test(i)), !f && g.regex && i.match && i.match(g.regex) && (f = i), !f
            );
          }),
          !f)
        )
          return (
            "console" in window &&
              window.console.error(
                "Featherlight: no content filter found " + (i ? ' for "' + i + '"' : " (no target specified)")
              ),
            !1
          );
      }
    ...
    setContent: function (b) {
      var c = this;
      return (
        (b.is("iframe") || a("iframe", b).length > 0) && c.$instance.addClass(c.namespace + "-iframe"),
    ...
    a.extend(b, {
      ...
      _callbackChain: {
        onKeyUp: function (a, b) {
          return 27 === b.keyCode
            ? (this.closeOnEsc && this.$instance.find("." + this.namespace + "-close:first").click(), !1)
            : a(b);
        },
